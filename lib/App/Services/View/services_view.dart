...
import '../Model/FixedServicesModel.dart';
          ...
          slivers: <Widget>[
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: servicesAppBar(context, viewModel: viewModel),
              ),
            ),
            SliverList(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            children: [
                              Obx(() => viewModel.serviceDashboardModel.value != null
                                  ? GridView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        if (viewModel.serviceDashboardModel.value!.randomServices == null) {
                                          return const SizedBox();
                                        }
                                        return servicesTile(
                                          onTap: () {
                                            Get.toNamed(AppRoutes.waterServiceForm,
                                                arguments: viewModel.serviceDashboardModel.value!.randomServices?[index]);
                                          },
                                          service: viewModel.serviceDashboardModel.value!
                              ...
                              textButton(
                                  context: context,
                                  title: context.local.other,
                                  onClick: () {
                                    Get.toNamed(AppRoutes.allParentServices);
                                  }),
                              // Nearby Services
                              getHeight(context, 0.015),
                              gridTitleTile(context, title: context.local.nearest_services,
                                  callBack: () {
                                Get.toNamed(
                                    AppRoutes.allServicesScreen,
                                    arguments: viewModel.serviceDashboardModel.value?.nearbyServices);
                              }, fontSize: 14),
                                  ...
                                  ? GridView.builder(
                                      ...
                                      gridDelegate:
                                          SliverGridDelegateWithFixedCrossAxisCount(
                                              crossAxisCount: 3,
                                              mainAxisExtent: context.getSize.height * 0.18,
                                              crossAxisSpacing:context.getSize.width * 0.016),
                                      itemCount: viewModel.serviceDashboardModel.value
                                          ?.nearbyServices?.length,
                                      itemBuilder: (context, index) {
                                        SellingServices service = viewModel
                                            .serviceDashboardModel.value!.nearbyServices![index];
                              ...
                              Obx(() => viewModel.serviceDashboardModel.value != null
                                  ? Column(children: [
                                      if (viewModel.serviceDashboardModel.value!.topSellingServices !=
                                          null &&
                                        ...
                                        gridTitleTile(context,
                                          ...
                                          Get.toNamed(
                                              AppRoutes.allServicesScreen,
                                              arguments: viewModel.serviceDashboardModel.value
                                                  ?.topSellingServices);
                                        }, fontSize: 14),
                                      getHeight(context, 0.008),
                                      GridView.builder(
                                          ...
                                          gridDelegate:
                                              SliverGridDelegateWithFixedCrossAxisCount(
                                                  ...
                                                  crossAxisSpacing: context.getSize.width * 0.016),
                                          itemCount: viewModel
                                              .serviceDashboardModel.value?.topSellingServices?.length,
                                          itemBuilder: (context, index) {
                                            SellingServices service = viewModel.serviceDashboardModel
                                                .value!.topSellingServices![index];
                                            return servicesBox(context, service,
                                                onClick: () {
                                              Get.toNamed(AppRoutes.serviceDetail, arguments: service);
                                            });
                              ...
                              FutureBuilder(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    if (snapshot.connectionState == ConnectionState.done) {
                                      ServicePaginationModel? serviceModel = snapshot.data;
                                      List<SellingServices> services = serviceModel?.results ?? [];
                                      return Column(
                                        children: [
                                          gridTitleTile(context,
                                              // title: context.local.topSellingServices,
                                              title: context.local.other_services,
                                              callBack: () {
                                            Get.toNamed(AppRoutes.allServicesScreen,arguments: services);
                                            },
                                              fontSize: 14),
                                          ListView.builder(
                                              physics: const BouncingScrollPhysics(),
                                              ...
                                              itemBuilder: (context, index) {
                                                return Padding(
                                                  ...
                                                  child: serviceTile(context,service: services[index]),
                                                );
                                              }),
                                        ],
                                      );
                              ...
                              if (snapshot.connectionState == ConnectionState.done) {
                                ...
                                return GridView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return fixedPriceServicesBox(
                                          context, service, onClick: () {
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                              padding: EdgeInsets.symmetric(horizontal: context.getSize.width * 0.082),
                              shrinkWrap: true,
                              itemCount: viewModel.topSellingList.length,
                              scrollDirection: Axis.horizontal,
                              itemBuilder: (context, index) {
                                ServicesModel services = viewModel.topSellingList[index];
