          ...
          viewModel.homeModel.value.data != null
            ...
            items: List.generate(
                viewModel.homeModel.value.data!.sliders.length,
                    (index) => viewModel.homeModel.value.data!.sliders[index].image !=
                    null
                    ? InstaImageViewer(
                  imageUrl: viewModel.homeModel.value.data!.sliders[index].image!,
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(10),
                    child: Image.network(
                      viewModel.homeModel.value.data!.sliders[index].image!,
                      fit: BoxFit.contain,
