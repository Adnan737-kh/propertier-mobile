...
// import 'package:propertier/App/Utils/logo_tile.dart';
...
import '../ViewModel/email_otp_confirm.dart';
import 'components/otp_verify_pin_field.dart';

class EmailOTPVerifyView extends StatelessWidget {
  EmailOTPVerifyView({super.key});
  final viewModel = Get.find<EmailOTPViewModel>();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: GetX<EmailOTPViewModel>(
          init: EmailOTPViewModel(),
          builder: (viewModel) {
            return SafeArea(
                child: Padding(
