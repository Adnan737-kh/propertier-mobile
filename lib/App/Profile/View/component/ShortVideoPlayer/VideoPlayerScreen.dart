...
class VideoPlayerScreen extends StatelessWidget {
  ...
  const VideoPlayerScreen(
      {super.key, required this.properties, required this.property});

  @override
  Widget build(BuildContext context) {
    // Initialize the controller with the list of URLs
    final VideoScreenController controller =
        Get.put(VideoScreenController(properties, property));
    if (kDebugMode) {
      print(
          'object user ${controller.properties[controller.activeVideoIndex.value].agent?.id!}');
    }
      ...
      body: Obx(() => PageView(
            ...
            children: controller.videoControllers.map((videoPlayerController) {
              return GestureDetector(
                onTap: () =>
                    controller.pauseOrPlayVideoC(videoPlayerController),
                child: Stack(
                  alignment: Alignment.center,
                  children: [
                    VideoPlayerWidget(
                        videoController: controller.videoControllers[
                                      ...
                                      await LikeAndUnlikeServices()
                                          .likeService(
                                              ...
                                              propertyId: controller
                                                  ...
                                                  .toString())
                                          .then((value) {
                                        controller.getSpecificPropertyDetail(
                                            controller.activeVideoIndex.value);
                                      });
                                    },
