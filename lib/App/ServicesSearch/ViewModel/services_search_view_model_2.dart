...
class ServicesSearhViewModel2 extends GetxController {
  ...
  ParentServicesModel parentServicesModel =
      Get.arguments['parentServicesModel'];
    ...
    try {
      ...
      channel.stream.listen(
        (data) {
          ...
          VendorOfferModel vendorOfferModel =
              VendorOfferModel.fromJson(jsonData);
          if (kDebugMode) {
  ...
  Future finalizeBid(
      BuildContext context, String id, String status, String vendorId) async {
  ...
  Future<bool> createOrder(
    ...
    bool res = await ServicesSearchService().createOrder(
        context: context,
        bidId: bidId,
        vendorId: vendorId,
        customerId: customerId,
        serviceId: parentServicesModel.id.toString(),
        subServiceId: subservices.id.toString(),
