class API {
  ...
  static const baseWebSocketURL =
      "ws://propertier-cloud-run-882044310734.asia-south2.run.app/";
  ...
  static const accountDeleteUrl = '$mainUrl/api/auth/user/me/delete/';
  ...
  static const updateProfileUrl = '$mainUrl/$secondaryUrl/update-customer-info/';
  ...
  static const addAwards = '$mainUrl/api/vendor-awards/';
  static const getAwards = '$mainUrl/api/awards-for-vendor';
  static const getServices = '$mainUrl/services/services-for-vendor';
  static const getFeaturedServices =
      '$mainUrl/services/vendor-featured-services';
  ...
  static const deleteAward = '$mainUrl/api/vendor-awards';
  static const uploadIDCardImages = '$mainUrl/api/vendors';
  static const fetchEarningData = '$mainUrl/services/vendor';
  static const postWithoutFeaturePackage = '$mainUrl/api/vendor-services/';
  ...
  static const fixedServices = '$mainUrl/api/fixed-services/';
  ...
  static const servicesWithPagination = '$mainUrl/api/vendor-services-with-pagination/';
...
class Finance {
  ...
  static const createIntentionTest = '${BaseUrl.baseURL}/finance/test-paymob-intention/';
  static const paymentStatusSocket = '${BaseUrl.baseWebSocketURL}/ws/finance/payment-status/';
}
