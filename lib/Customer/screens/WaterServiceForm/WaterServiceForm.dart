                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Obx(()=> DropdownButton<String>(
                        value: controller.selectedWaterType.value,
                        hint: const Text('Water Type'),
                        isExpanded: true, // Ensures dropdown takes full width
                        items: <String>['Drinking Water', 'Normal Water']
                        ...
                        onChanged: (String? newValue) {
                          controller.selectedWaterType.value = newValue;
                        },
                        style: const TextStyle(fontSize: 14,color: AppColor.blackColor), // Customize text style
                      )),
                      getHeight(context, 0.016),
                      Obx(()=> DropdownButton<String>(
                        value: controller.selectedPacking.value,
                        hint: const Text('Packing'),
                        isExpanded: true, // Ensures dropdown takes full width
                        items: <String>['Bottle Pack', 'Plastic Gallons', 'Container']
                            .map((String value) => DropdownMenuItem<String>(
                          value: value,
                          child: Text(value),
                        ))
                            .toList(),
                        onChanged: (String? newValue) {
                          controller.selectedPacking.value = newValue;
                        },
                        style: const TextStyle(fontSize: 14,color: AppColor.blackColor), // Customize text style
                      )),
                      getHeight(context, 0.016),
                      Obx(()=> DropdownButton<String>(
                        ...
                        isExpanded: true, // Ensures dropdown takes full width
                        items: <String>['Pickup', 'By Water Provider']
                            .map((String value) => DropdownMenuItem<String>(
                          value: value,
                          child: Text(value),
                        ))
                            .toList(),
                        onChanged: (String? newValue) {
                          controller.selectedDeliveryType.value = newValue;
                        },
                        style: const TextStyle(fontSize: 14,color: AppColor.blackColor), // Customize text style
                      )),
                      // getHeight(context, 0.016),
