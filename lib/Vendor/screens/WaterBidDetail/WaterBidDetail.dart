  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: appText(title: "Water Bid Detail", context: context,fontSize: 16,fontWeight: FontWeight.w600),
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              ListTile(
                title: appText(title: "Water Type", context: context,fontWeight: FontWeight.w600,fontSize: 14, textAlign: TextAlign.start),
                subtitle: appText(title: "Drinking Water", context: context,fontWeight: FontWeight.w500,fontSize: 14, textAlign: TextAlign.start),
              ),
              ListTile(
                title: appText(title: "Delivery Service", context: context,fontWeight: FontWeight.w600,fontSize: 14, textAlign: TextAlign.start),
                subtitle: appText(title: "By Water Provider", context: context,fontWeight: FontWeight.w500,fontSize: 14, textAlign: TextAlign.start),
              ),
              ListTile(
                title: appText(title: "Packing Type", context: context,fontWeight: FontWeight.w600,fontSize: 14, textAlign: TextAlign.start),
                subtitle: appText(title: "200 liter container", context: context,fontWeight: FontWeight.w500,fontSize: 14, textAlign: TextAlign.start),
              ),
              ListTile(
