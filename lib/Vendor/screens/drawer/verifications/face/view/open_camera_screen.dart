...
class OpenCameraScreen extends StatefulWidget {
  ...
  @override
  State<OpenCameraScreen> createState() =>
      _OpenCameraScreenState();
}

class _OpenCameraScreenState
    extends State<OpenCameraScreen> {
  @override
                 ...
                 Padding(
                   ...
                   child: Column(
                    ...
                    height: Get.height * .12,
                                   ...
                                   InkWell(
                    onTap: () {
                                       Get.to(() => const SuccessScreen(text: 'Face Verification'));
