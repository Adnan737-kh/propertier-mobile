...
class FeatureAdsDetailScreen extends StatefulWidget {
  final FeatureAd featureAd;

  const FeatureAdsDetailScreen({super.key, required this.featureAd});

  @override
  State<FeatureAdsDetailScreen> createState() => _FeatureAdsDetailScreenState();
}

class _FeatureAdsDetailScreenState extends State<FeatureAdsDetailScreen> {
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ListView.builder(
                        itemCount: featureAd.vendorService.imageUrls.length,
                        shrinkWrap: true,
                        scrollDirection: Axis.horizontal,
                        physics: const BouncingScrollPhysics(),
                        itemBuilder: (context, index) {
                          final imageUrl =
                              featureAd.vendorService.imageUrls[index];
                          return InkWell(
                              onTap: () {
                                setState(() {
                                ...
                                child: (imageUrl.isNotEmpty)
                                    ? FadeInImage.assetNetwork(
                                        ...
                                        imageErrorBuilder:
                                          ...
                                          // If image fails to load, display the placeholder
                                          return Image.asset(
