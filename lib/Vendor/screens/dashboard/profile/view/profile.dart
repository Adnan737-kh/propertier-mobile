...
class ProfileScreen extends StatefulWidget {
  ...
  const ProfileScreen({super.key, required this.onViewAllTap});
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                            ...
                            decoration: ShapeDecoration(
                              ...
                              image: DecorationImage(
                                image: _getImageProvider(
                                  profileController.profileModel.value.user?.coverPhoto,
                                ),
                                fit: BoxFit.cover,
                                alignment: Alignment.center,
                              ),
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: NetworkImage(profileController
                                          .profileModel.value.user?.profilePicture ??
                        ...
                        child: Row(
                          ...
                          children: [
                            Column(
                              children: [
                                Text(
                                  profileController.profileModel.value.user?.followers
                                      .toString() ?? '0',
                            ...
                            Column(
                              children: [
                                Text(
                                  profileController.profileModel.value.user?.likes
                                      .toString() ?? '0',
                                  style: const TextStyle(
                                    color: Color(0xFFFDCD54),
                                    fontSize: 18,
                      ...
                      Text(
                        profileController.profileModel.value.user?.fullName.toString()??"unknown",
                        style: const TextStyle(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            const Icon(Icons.work_history_rounded,color: Color(0xFFFDCD54),),
                              Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text(profileController.profileModel.value.user?.fullName.toString()??'unknown'),
                                Text(
                                  profileController.profileModel.value.user?.designation??"not specified yet",
                                  style: const TextStyle(
                                ...
                                Container(
                                  ...
                                  child: TextField(
                                    controller: TextEditingController(
                                      text:profileController.profileModel.value.user?.about.toString()??'missing',
                                    ),
                                    enabled: false,
                                            ...
                                            if (profileController.image != null
                                              ...
                                              try {
                                                await profileController
                                                    .addService(awardModel,profileController.accessToken!,context);
